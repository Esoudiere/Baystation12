...
/obj/machinery/telecomms/proc/relay_information(datum/signal/signal, filt, copysig, amount = 20)
	// relay signal to all linked machinery that are of type [filt]. If signal has been sent [amount] times, stop sending
