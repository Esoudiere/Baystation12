...
/obj/item/weapon/gun/energy/advanced/attack_self(mob/living/user as mob)
	ui_interact(user)

/obj/item/weapon/gun/energy/advanced/proc/spark()
	var/datum/effect/effect/system/spark_spread/s = new /datum/effect/effect/system/spark_spread
	s.set_up(rand(2,10), 1, src)
	s.start()

/obj/item/weapon/gun/energy/advanced/consume_next_projectile(var/mob/living/carbon/human/user)
